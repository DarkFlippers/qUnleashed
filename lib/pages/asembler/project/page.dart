...
import '../../apps/manager/widgets/fap_facts.dart';
...
class _FliblerProjectPageState extends State<FliblerProjectPage> {
  ...
  void _openSettings() {
    Navigator.of(context).push(
      MaterialPageRoute(builder: (_) => const AssemblerSettingsPage()),
    );
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  if (version.isNotEmpty) _Meta(label: 'Version', value: version),
