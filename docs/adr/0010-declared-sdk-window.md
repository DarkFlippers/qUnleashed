...
same fix on their own branches. At the time this was decided the app was also
pinned three commits behind `flipperlib`'s `dev` by breaking API changes
(issue #144); that migration landed separately in #127.
