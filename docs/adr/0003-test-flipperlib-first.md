...
This is also the gate that unblocks [0001](0001-state-management.md) and the
precondition for the API migration in issue #144.
...
- Two other pieces of work now depend on this: [0001](0001-state-management.md)
  and issue #144.
